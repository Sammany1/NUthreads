...
To update the database use this command from the Web project folder (replace `NUthreads` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../NUthreads.Infrastructure/NUthreads.Infrastructure.csproj -s NUthreads.Web.csproj
```
